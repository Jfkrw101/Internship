...
class BYTETrackerReID:
    ...
    def update(self, results, img=None):
        ...
        detections_second = self.init_track(dets_second, scores_second, cls_second, features)
    ...
    def init_track(self, dets, scores, cls, features):
        """Initialize object tracking with detections and scores using STrack algorithm."""
        return [STrack(xyxy, s, c, f) for (xyxy, s, c, f) in zip(dets, scores, cls, features)] if len(dets) else []  # detections
